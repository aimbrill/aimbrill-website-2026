          ...
          <div className="md:col-span-3">
            ...
            <div className="mt-4 flex items-center gap-3">
              <a
                ...
                className="hover-lift inline-flex size-11 shrink-0 items-center justify-center rounded-full border border-border bg-card text-ink transition-all duration-300 hover:border-[color:var(--lime)] hover:bg-[color:var(--lime)]/15 hover:shadow-[0_0_18px_var(--lime)]"
              >

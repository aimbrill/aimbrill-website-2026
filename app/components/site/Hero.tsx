  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center px-4 text-center">
        ...
        <h1 className="mt-4 max-w-4xl font-display text-[32px] sm:text-[46px] md:text-[58px] lg:text-[68px] font-semibold leading-[1.12] sm:leading-[1.04] tracking-tight text-ink">
          We build AI automation, smart apps & solutions for D2C brands.
        </h1>

        <p className="mt-3.5 max-w-2xl text-[14px] sm:text-[16px] text-muted-foreground leading-relaxed">
        ...
        <div className="mt-6 flex justify-center">
          <Image
            ...
            className="mx-auto object-contain w-[160px] sm:w-[200px] md:w-[300px] h-auto"
          />
        </div>
      </div>
    </section>
